...
public class ThursFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v=inflater.inflate(R.layout.fragment_thurs, container, false);
        listView=v.findViewById(R.id.thursRecyclerView);
            ...
            public void onVollyResponce(String responce) {
                ...
                try {
                    ...
                    for(int i=3;i<jsonArray.length();i++)
                    {
                        ...
                        JSONArray jsonArray1 = object1.getJSONArray("Thurs");
