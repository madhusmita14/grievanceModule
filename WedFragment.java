...
public class WedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v=inflater.inflate(R.layout.fragment_wed, container, false);
        listView=v.findViewById(R.id.wedRecyclerView);
        linearLayout=v.findViewById(R.id.dynamicLayout);
            ...
            public void onVollyResponce(String responce) {
                ...
                try {
                    ...
                    for(int i=2;i<jsonArray.length();i++)
                    {
                        ...
                        JSONArray jsonArray1 = object1.getJSONArray("Wed");
